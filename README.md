...
NTOS is built from first principles around *observable behavior* rather than declared identity.
...
NTOS makes approximately **65 discrete, testable technical contributions**.  
Each claim maps directly to code, benchmarks, or documentation in this repository.
